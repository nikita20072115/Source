...
#include "PoweredSpotLightComponent.generated.h"

/**
 * @class UPoweredSpotLightComponent
 */
...
class SUMMERCAMP_API UPoweredSpotLightComponent
	: public USpotLightComponent
	, public ISCPoweredObject
{
	GENERATED_BODY()

public:
	UPoweredSpotLightComponent(const FObjectInitializer& ObjectInitializer);
